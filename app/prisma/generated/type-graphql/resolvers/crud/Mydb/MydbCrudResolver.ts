...
export class MydbCrudResolver {
  ...
  async aggregateMydb(@Context() ctx: any, @Info() info: GraphQLResolveInfo, @Args() args: AggregateMydbArgs): Promise<AggregateMydb> {
  ...
  async createManyMydb(@Context() ctx: any, @Info() info: GraphQLResolveInfo, @Args() args: CreateManyMydbArgs): Promise<AffectedRowsOutput> {
  ...
  async createOneMydb(@Context() ctx: any, @Info() info: GraphQLResolveInfo, @Args() args: CreateOneMydbArgs): Promise<Mydb> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async findFirstMydb(@Context() ctx: any, @Info() info: GraphQLResolveInfo, @Args() args: FindFirstMydbArgs): Promise<Mydb | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async updateManyMydb(@Context() ctx: any, @Info() info: GraphQLResolveInfo, @Args() args: UpdateManyMydbArgs): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async updateOneMydb(@Context() ctx: any, @Info() info: GraphQLResolveInfo, @Args() args: UpdateOneMydbArgs): Promise<Mydb | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async upsertOneMydb(@Context() ctx: any, @Info() info: GraphQLResolveInfo, @Args() args: UpsertOneMydbArgs): Promise<Mydb> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
