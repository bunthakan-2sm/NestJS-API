...
export class MyuserCrudResolver {
  ...
  async aggregateMyuser(@Context() ctx: any, @Info() info: GraphQLResolveInfo, @Args() args: AggregateMyuserArgs): Promise<AggregateMyuser> {
  ...
  async createOneMyuser(@Context() ctx: any, @Info() info: GraphQLResolveInfo, @Args() args: CreateOneMyuserArgs): Promise<Myuser> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async deleteOneMyuser(@Context() ctx: any, @Info() info: GraphQLResolveInfo, @Args() args: DeleteOneMyuserArgs): Promise<Myuser | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async findFirstMyuser(@Context() ctx: any, @Info() info: GraphQLResolveInfo, @Args() args: FindFirstMyuserArgs): Promise<Myuser | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async groupByMyuser(@Context() ctx: any, @Info() info: GraphQLResolveInfo, @Args() args: GroupByMyuserArgs): Promise<MyuserGroupBy[]> {
  ...
  async updateOneMyuser(@Context() ctx: any, @Info() info: GraphQLResolveInfo, @Args() args: UpdateOneMyuserArgs): Promise<Myuser | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
